...
//    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        boolean editable = typedArray.getBoolean(R.styleable.NumberButton_nBtn_editable, true);
        int buttonWidth = typedArray.getDimensionPixelSize(R.styleable.NumberButton_nBtn_buttonWidth, -1);
        int textWidth = typedArray.getDimensionPixelSize(R.styleable.NumberButton_nBtn_textWidth, -1);
        int textSize = typedArray.getDimensionPixelSize(R.styleable.NumberButton_nBtn_textSize, -1);
        int textColor = typedArray.getColor(R.styleable.NumberButton_nBtn_textColor, 0xff000000);
        typedArray.recycle();
